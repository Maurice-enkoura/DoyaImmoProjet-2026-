...
<head>
    ...
    <title>Rappel de visite — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;"> Rappel de votre rendez-vous</h2>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Ceci est un rappel pour votre rendez-vous prévu :
                </p>
                
                <div style="background-color: #E3F2FD; border: 1px solid #90CAF9; border-radius: 8px; padding: 20px; margin: 24px 0;">
                    <h3 style="color: #1565C0; margin-top: 0; font-size: 18px;"> Détails du rendez-vous</h3>
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-top: 12px;">
                        ...
                        @if($rendezVous->agence && $rendezVous->agence->adresse)
                        <tr>
                            <td style="padding: 8px 0; color: #8A8AA0; font-size: 14px;"> Adresse :</td>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 16px; font-weight: bold;">
                                {{ $rendezVous->agence->adresse }}
                            </td>
                        </tr>
                        @endif
                        @if($rendezVous->agence && $rendezVous->agence->user && $rendezVous->agence->user->telephone)
                        <tr>
                            <td style="padding: 8px 0; color: #8A8AA0; font-size: 14px;"> Téléphone :</td>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 16px; font-weight: bold;">
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    En cas d'imprévu, n'hésitez pas à contacter l'agence.
                </p>
                
                <div style="text-align: center; margin: 32px 0;">
                    <a href="{{ url('/particulier/rendezvous/' . $rendezVous->id) }}" 
