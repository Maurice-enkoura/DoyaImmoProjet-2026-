...
<head>
    ...
    <title>Agence validée — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;"> Votre agence DoyaImmo a été validée</h2>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Nous avons le plaisir de vous informer que votre agence <strong>{{ $agence->nom_agence }}</strong> a été validée avec succès sur la plateforme DoyaImmo.
                </p>
                ...
                <div style="background-color: #E8F5E9; border: 1px solid #C8E6C9; border-radius: 8px; padding: 20px; margin: 24px 0;">
                    ...
                    <ul style="color: #4A4A6A; font-size: 15px; line-height: 1.8; padding-left: 20px; margin-top: 8px;">
                        <li> <strong>Publier des biens immobiliers</strong></li>
                        <li> <strong>Répondre aux demandes des clients</strong></li>
                        <li> <strong>Gérer vos rendez-vous</strong></li>
                        <li> <strong>Suivre vos statistiques</strong></li>
                    </ul>
                </div>
                
                <div style="background-color: #E8F5E9; border: 1px solid #C8E6C9; border-radius: 8px; padding: 16px; margin-top: 24px;">
                    <p style="margin: 0; color: #2E7D32; font-size: 14px; line-height: 1.6;">
                        <strong> Prêt à démarrer ?</strong> Connectez-vous à votre espace agence DoyaImmo pour publier vos biens et répondre aux demandes.
                    </p>
                </div>
                
                <div style="text-align: center; margin: 32px 0;">
                    <a href="{{ url('/agence/dashboard') }}" 
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Bienvenue dans la communauté DoyaImmo !
                </p>
