...
<head>
    ...
    <title>Demande annulée — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;"> Demande annulée</h2>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    La demande de <strong>{{ $demande->type_bien->label() ?? 'bien' }}</strong> à <strong>{{ $demande->zone_recherchee }}</strong> a été annulée par le particulier.
                </p>
                
                <div style="background-color: #FFF8E1; border: 1px solid #FFE082; border-radius: 8px; padding: 20px; margin: 24px 0;">
                    <h3 style="color: #F57F17; margin-top: 0; font-size: 18px;"> Détails de la demande annulée</h3>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Consultez les autres demandes disponibles sur DoyaImmo.
                </p>
                ...
                <div style="background-color: #F7F9FC; border: 1px solid #E8E8F0; border-radius: 8px; padding: 16px; margin-top: 24px;">
                    <p style="margin: 0; color: #4A4A6A; font-size: 14px; line-height: 1.6;">
                        <strong> Astuce :</strong> Connectez-vous à votre espace DoyaImmo pour voir d'autres demandes compatibles avec vos biens.
                    </p>
                </div>
