...
<head>
    ...
    <title>Mise en vedette annulée — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;"> Mise en vedette annulée</h2>
                
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Bonjour <strong>{{ $notifiable->prenom }} {{ $notifiable->nom }}</strong>,
                </p>
                
                <div style="background-color: #FFEBEE; border: 1px solid #FFCDD2; border-radius: 8px; padding: 16px; margin: 24px 0; text-align: center;">
                    <span style="font-size: 40px;"></span>
                    <p style="color: #C62828; font-size: 16px; font-weight: bold; margin: 8px 0 0 0;">
                        Mise en vedette annulée
                    </p>
                </div>
                
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Nous vous informons que votre demande de mise en vedette a été annulée.
                </p>
                
                <div style="background-color: #F7F9FC; border: 1px solid #E8E8F0; border-radius: 8px; padding: 20px; margin: 24px 0;">
                    <h3 style="color: #1A1A2E; margin-top: 0; font-size: 18px;">📋 Détails de l'annulation</h3>
                    
                    <table style="width: 100%; border-collapse: collapse; margin-top: 12px;">
                        <tr>
                            <td style="padding: 8px 0; color: #8A8AA0; font-size: 14px; width: 40%;">Bien concerné :</td>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 16px; font-weight: bold;">
                                {{ $bien->titre }}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #8A8AA0; font-size: 14px;">Motif :</td>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 16px; font-weight: bold;">
                                {{ $motif }}
                            </td>
                        </tr>
                ...
                <div style="background-color: #E3F2FD; border: 1px solid #BBDEFB; border-radius: 8px; padding: 16px; margin: 24px 0;">
                    <p style="margin: 0; color: #0D47A1; font-size: 14px; line-height: 1.6;">
                        <strong>💡 Besoin d'aide ?</strong> Si vous avez des questions ou souhaitez contester cette décision, n'hésitez pas à nous contacter.
                    </p>
                </div>
                ...
                <p style="color: #8A8AA0; font-size: 14px; line-height: 1.6;">
                    Cordialement, L'équipe DoyaImmo.
                </p>
            </div>
