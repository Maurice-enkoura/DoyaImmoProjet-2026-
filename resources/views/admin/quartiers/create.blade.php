...
@section('title', 'Nouveau quartier — Administration DoyaImmo')
@section('page_title', 'Nouveau quartier')
@section('page_sub', 'Ajouter un quartier à la plateforme')
...
<div class="panel" style="max-width:600px;margin:0 auto;">
    ...
    <form method="POST" action="{{ route('admin.quartiers.store') }}">
        @csrf
        ...
        <div style="display:flex;gap:12px;padding-top:16px;border-top:1px solid var(--border);margin-top:16px;">
            <button type="submit" class="btn btn-rust" style="flex:1;">
                <i class="fa-solid fa-save"></i> Créer le quartier
            </button>
