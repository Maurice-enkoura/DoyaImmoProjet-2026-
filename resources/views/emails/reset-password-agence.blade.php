...
<head>
    ...
    <title>Réinitialisation de mot de passe — Espace Agence — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;">Réinitialisation de votre mot de passe</h2>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Vous avez demandé à réinitialiser votre mot de passe pour votre <strong>compte agence DoyaImmo</strong>.
                </p>
                
                <div style="text-align: center; margin: 32px 0;">
                    <a href="{{ url('/agence/reinitialiser-mot-de-passe/' . $token . '?email=' . urlencode($user->email)) }}" 
                ...
                <p style="color: #4A4A6A; font-size: 14px; margin-top: 24px;">
                    ...
                    <a href="{{ url('/agence/reinitialiser-mot-de-passe/' . $token . '?email=' . urlencode($user->email)) }}" style="color: #B85C3A; word-break: break-all;">
                        {{ url('/agence/reinitialiser-mot-de-passe/' . $token . '?email=' . urlencode($user->email)) }}
                    </a>
                </p>
            </div>
