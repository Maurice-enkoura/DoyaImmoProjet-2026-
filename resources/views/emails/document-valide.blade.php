...
<head>
    ...
    <title>Document validé — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;"> Document validé</h2>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Nous vous informons que votre document <strong>{{ $document->type_document_label }}</strong> a été <strong style="color: #2E7D32;">validé</strong> avec succès.
                </p>
                
                <div style="background-color: #E8F5E9; border: 1px solid #C8E6C9; border-radius: 8px; padding: 20px; margin: 24px 0;">
                    <h3 style="color: #2E7D32; margin-top: 0; font-size: 18px;"> Document accepté</h3>
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse; margin-top: 12px;">
                        ...
                        <tr>
                            ...
                            <td style="padding: 8px 0; color: #2E7D32; font-size: 14px; font-weight: bold;"> Validé</td>
                        </tr>
                    </table>
                </div>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Merci de votre confiance en DoyaImmo !
                </p>
