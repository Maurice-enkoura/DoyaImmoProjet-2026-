                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <div style="display:flex;gap:4px;justify-content:center;flex-wrap:wrap;">
                            ...
                            <a href="{{ route('admin.demandes.show', $demande->slug) }}" class="btn btn-sm btn-ghost" title="Voir">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                            <!-- ✅ CORRIGÉ : Utilisation du slug -->
                            <form action="{{ route('admin.demandes.destroy', $demande->slug) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
