        ...
        <div style="padding:24px;">
            ...
            <div style="margin-bottom:24px;">
                <h4 style="font-family:var(--display);font-size:14px;margin-bottom:12px;color:var(--text-soft);">
                    <i class="fa-regular fa-images" style="margin-right:8px;"></i>Photos du bien
                </h4>
                @php
                    $images = $proposition->bien->medias->where('type_media', 'image');
                @endphp
                ...
                @else
                    <div style="padding:40px;background:#F7F9FC;border-radius:10px;text-align:center;color:var(--muted);border:1px dashed var(--border);">
                ...
                <!-- Vidéos -->
                @php
                    $videos = $proposition->bien->medias->where('type_media', 'video');
                @endphp
                @if($videos->count() > 0)
