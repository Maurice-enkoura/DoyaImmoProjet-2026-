...
<head>
    ...
    <title>Demande de visite — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;">📅 Nouvelle demande de visite</h2>
                ...
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Un client a demandé une visite pour le bien <strong>{{ $bien }}</strong>.
                </p>
                
                <div style="background-color: #F7F9FC; border: 1px solid #E8ECF0; border-radius: 8px; padding: 20px; margin: 24px 0;">
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                        <tr>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 14px; width: 50%;"><strong>Client :</strong></td>
                            <td style="padding: 8px 0; color: #1A1A2E; font-size: 14px;">{{ $client }}</td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 14px;"><strong>Bien :</strong></td>
                            <td style="padding: 8px 0; color: #1A1A2E; font-size: 14px;">{{ $bien }}</td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 14px;"><strong>Date :</strong></td>
                            <td style="padding: 8px 0; color: #1A1A2E; font-size: 14px;">{{ $date }}</td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #4A4A6A; font-size: 14px;"><strong>Heure :</strong></td>
                            <td style="padding: 8px 0; color: #1A1A2E; font-size: 14px;">{{ $heure }}</td>
                        </tr>
                    </table>
                </div>
                
                <div style="text-align: center; margin: 32px 0;">
                    <a href="{{ route('agence.rendezvous.show', $rendezVous->id) }}" 
