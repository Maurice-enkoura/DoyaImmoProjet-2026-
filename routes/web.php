...
/*
|--------------------------------------------------------------------------
| SITEMAP DYNAMIQUE - PUBLIC (hors middleware auth)
|--------------------------------------------------------------------------
*/
Route::get('/sitemap.xml', function () {
    $biens = \App\Models\BienImmobilier::where('statut', true)->get();
    $demandes = \App\Models\DemandeImmobiliere::where('statut', 'en_attente')->get();
    $agences = \App\Models\Agence::where('statut_validation', true)->get();

    return response()->view('sitemap', compact('biens', 'demandes', 'agences'))
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    Route::prefix('agence')->name('agence.')->middleware(['role:agence'])->group(function () {
        ...
        Route::get('/attente-validation', [\App\Http\Controllers\Agence\AttenteValidationController::class, 'index'])
        ...
        // ============ ABONNEMENT - MASQUÉ SI MODE GRATUIT ============
        // ✅ Utilisation de PHP pur, pas de directives Blade
...
Route::prefix('admin')->name('admin.')->middleware(['role:admin'])->group(function () {
    ...
    Route::post('/agences/{agence:slug}/documents/{document}/rejeter', 
        [AdminAgenceController::class, 'rejeterDocument'])
        ->name('agences.rejeter-document');
