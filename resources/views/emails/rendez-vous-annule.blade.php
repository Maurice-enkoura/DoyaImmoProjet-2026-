...
<head>
    ...
    <title>Rendez-vous annulé — DoyaImmo</title>
</head>
    ...
    <div style="background-color: #f4f4f4; padding: 40px 20px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 32px;">
                <h2 style="color: #1A1A2E; margin-top: 0; font-size: 22px;"> Rendez-vous annulé</h2>
                
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Bonjour <strong>{{ $rendezVous->particulier->user->prenom ?? $notifiable->prenom }}</strong>,
                </p>
                
                <p style="color: #4A4A6A; font-size: 16px; line-height: 1.6;">
                    Votre rendez-vous a été <strong>annulé</strong>.
                </p>
                
                <div style="background-color: #FFF5F5; border: 1px solid #FFCDD2; border-radius: 8px; padding: 20px; margin: 24px 0;">
                    <h3 style="color: #C62828; margin-top: 0; font-size: 18px;">📋 Détails du rendez-vous annulé</h3>
                ...
                <div style="background-color: #F7F9FC; border: 1px solid #E8E8F0; border-radius: 8px; padding: 16px; margin-top: 24px;">
                    <p style="margin: 0; color: #4A4A6A; font-size: 14px; line-height: 1.6;">
                        <strong>💡 Astuce :</strong> Connectez-vous à votre espace DoyaImmo pour planifier un nouveau rendez-vous facilement.
                    </p>
                </div>
                
                <div style="text-align: center; margin: 32px 0;">
                    <a href="{{ url('/particulier/rendezvous/create') }}" 
